			...
			<div className="gallery">
				...
				<Link href="/gallery/product" passHref>
					<div className="gallery__item">
						<div className="gallery__item__image">
							<img
								src="/assets/showcase/product.jpg"
								alt=""
								title=""
								width="100%"
								height="100%"
				...
				<Link href="/gallery/wedding" passHref>
					<div className="gallery__item">
						<div className="gallery__item__image">
							<img
								src="/assets/showcase/wedding.jpg"
								alt=""
								title=""
								width="100%"
								height="100%"
				...
				<Link href="/gallery/closeup" passHref>
					<div className="gallery__item">
						<div className="gallery__item__image">
							<img
								src="/assets/showcase/closeup.jpg"
				...
				<Link href="/gallery/beauty" passHref>
					<div className="gallery__item">
						<div className="gallery__item__image">
							<img
								src="/assets/showcase/beauty.jpg"
								alt=""
								title=""
								width="100%"
								height="100%"
				...
				<Link href="/gallery/fashion" passHref>
					<div className="gallery__item">
						<div className="gallery__item__image">
							<img
								src="/assets/showcase/fashion.jpg"
								alt=""
								title=""
								width="100%"
								height="100%"
